...
### get_global_record_leaderboard

The `get_global_record_leaderboard` method was renamed to
[`get_global_leaderboards`][wom.RecordService.get_global_leaderboards] for brevity.
